...
contract FarkleGameImplTestHarness is FarkleGameImpl {
	...
	function initialize(address _room, address[] calldata _players) external override {
...
contract FarkleGameImplTest is Test {
	...
	function setUp() public {
		farkleGameImpl = new FarkleGameImpl();
		testHarness = new FarkleGameImplTestHarness();
	}
